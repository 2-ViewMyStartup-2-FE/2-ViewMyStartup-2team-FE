...
import arrow from "../asset/image/img_sort.png"; // 화살표 이미지 임포트
...
function SortSelector() {
  ...
  const customStyles = {
    ...
    singleValue: (provided) => ({
      ...
      color: "#D8D8D8",
      paddingLeft: isMobile ? "0.08rem" : "0.1rem" // 왼쪽 패딩 추가
    }),
    option: (provided, state) => ({
      ...provided,
      width: isMobile ? "14.6rem" : "16.8rem", // 드롭다운 옵션의 너비 설정
    ...
    dropdownIndicator: (provided) => ({
      ...
      marginRight: isMobile ? "0.8rem" : "0.12rem",
      display: "flex", // 플렉스 박스 설정
      alignItems: "center", // 수직 정렬
